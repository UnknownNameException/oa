...
public class TaskNode {
	...
	public String toString() {
		return "TaskNode [taskNodeId=" + taskNodeId + ", taskId=" + taskId + ", workflowId=" + workflowId
				+ ", workflowNodeId=" + workflowNodeId + ", taskNodeSort=" + taskNodeSort + ", taskNodeApprover="
				+ taskNodeApprover + ", taskNodeStatus=" + taskNodeStatus + ", approvalOpinion=" + approvalOpinion
